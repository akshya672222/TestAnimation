...
//    
////    UITableView *tableViewAppearance = [UITableView appearanceWhenContainedIn:[UIView class], nil];
////    [tableViewAppearance setBackgroundColor:[UIColor clearColor]];
//
//    [[UITableView appearance] setBackgroundColor:[UIColor clearColor]];
//    [[UITableView appearance] setBackgroundView:[[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"Digit3"] applyLightEffect]]];
//    
